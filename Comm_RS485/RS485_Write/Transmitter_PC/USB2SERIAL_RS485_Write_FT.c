	...
	//----------------------------------------------------------------------------------------------------//
	// Program to send a character through RS485 link from PC/Laptop to MSP430 microcontroller.           //
	...
	//                                                                                                    //
	// Program runs on the PC side (Windows) and transmits a single character.Program opens a connection  //
	// to the USB2SERIAL board and sets the Parity bits,baudrate etc for communication.Program then puts  //
	// the FT232 (in USB2SERIAL board) in CBUS bit bang mode to use CBUS1 and CBUS2 to control ~RE and DE.//
    //                                                                                                    //
	// BaudRate     -> 9600                                                                               //
	...
	// Library   :  ftd2xx.lib                                                                            //
	// Commands  :  gcc -o USB2SERIAL_RS485_Write_FT USB2SERIAL_RS485_Write_FT.c ftd2xx.lib               //
	...
	void main(void)
	{
		...
		printf("\n\n\n   +========================================================+");
		printf("\n   |      RS485 Mode - Transmission (using ftd2xx.lib)      |");
		printf("\n   +========================================================+");
		...
		if(ft_status == FT_OK)             		 // Error checking for FT_Writee()
		    printf("\n\n     %c written to the serial port at %d bps",TxByte,BaudRate);
		else
